...
export const propsType = (convert: any) => ({ name, operationType }: any, options: Handlebars.HelperOptions) => {
...
const transformFragments = (convert: any) => (document: string, options: Handlebars.HelperOptions): string[] | undefined => {
